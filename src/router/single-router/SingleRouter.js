      ...
      <div className="product__overall">
        <div className="product_pic_info">
          <div className="product__pic">
            <img src={oneItem?.img[0]} alt="" />
          </div>
          <div className="product__info">
            <h3 className="product_name_info">{oneItem?.name}</h3>
...
<div className="product__share">
            ...
            <button className="sing__btn"><p>Bir bosishda sotib olish</p> </button>
          </div>
        </div>
      </div>
      <div className="product__description">
        ...
        <h1>Lorem, ipsum.</h1>
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. At harum  molestiae voluptatibus sint saepe sequi nulla sapiente nostrum cumque inventore ipsum odio deleniti nam neque dolorum itaque accusamus quia ullam cum animi, dolores culpa ratione. Optio veniam cumque, expedita accusantium iure neque deleniti sunt architecto cupiditate error necessitatibus nulla eaque, dicta, culpa facilis laudantium cum autem. Blanditiis voluptates vel debitis quae, nemo fugit natus laudantium culpa quis unde, consequatur facilis eos aut necessitatibus optio minus iusto quidem corrupti recusandae?</p>
        <h1>Lorem, ipsum.</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        <h1>Lorem</h1>
        <p>Lorem ipsum dolor sit amet  adipisicing elit. Praesentium, impedit in. Eaque possimus temporibus tenetur minus quo quae hic minima natus necessitatibus!</p>
        ...
        <h1>Lorem, ipsum.</h1>
        <p>Lorem ipsum dolor sit  consectetur, adipisicing elit. Voluptate nemo fuga saepe voluptatem, quos commodi dolorum ducimus repellat, eius, voluptatibus eos sunt nostrum vel quod non nisi dolores. Autem deserunt minima officiis modi libero cumque pariatur illo dolorum quidem. Nam.</p>
      </div>
    </div>
  );
}
